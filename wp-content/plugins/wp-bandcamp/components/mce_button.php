		...
		<div id="bc-dialog">
			<div class="bc-dialog-content">
				...
				<p>
					...
					<input class="bc-picker-field" id="bc-bg_color" name="bc-bg_color" style="background-color:<?php echo $defaults['bg_color']; ?>" type="text" value="<?php echo $defaults['bg_color']; ?>" size="6" maxlength="7" /> &nbsp;
					
					<label for="bc-link_color"><?php _e('Links Color'); ?>:</label>
					<input class="bc-picker-field" id="bc-link_color" name="bc-link_color" style="background-color:<?php echo $defaults['link_color']; ?>" type="text" value="<?php echo $defaults['link_color']; ?>" size="6" maxlength="7" />
				</p>		
...
#bc-size {
	...
	function wp_bandcamp_ok()
	{
		...
		if (id)
		{
			...
			var bg_color = jQuery('#bc-bg_color').val();
			var link_color = jQuery('#bc-link_color').val();
			
			var text = '[wp_bandcamp_player type="' + type + '" id="' + id + '" size="' + size + '" bg_color="' + bg_color + '" link_color="' + link_color + '"]';
